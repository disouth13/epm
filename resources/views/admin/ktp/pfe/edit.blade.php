    ...
    <div class="col-md-12">
        <div class="card shadow mb-4 border-left-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('update-pfe-ktp') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <input type="hidden" name="usersid" id="userid" value="{{ $ambilDataPfe->users_id }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 mr-2 mt-3">
                                ...
                                <div class="card">
                                    <img src="{{ asset($ambilDataPfe->photo) }}" class="card-img-top img-fluid" id="showImageSebelum" style="height: auto;">
                                    <div class="card-body">
