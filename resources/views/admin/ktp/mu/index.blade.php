                ...
                <div class="card-body">
                    {{-- error handling --}}
                        ...
                        @endif  
                            ...
                            <div class="mb-3">
                                <a href="{{ route('add-mu-ktp') }}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="bi bi-plus-square-fill mr-2"></i> Tambah Data</a>
                            </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">    
                                                <a href="{{ route('view-mu-ktp', $muItem->mus_id) }}" class="btn btn-primary btn-sm mb-1" title="Lihat Data"><i class="bi bi-binoculars-fill"></i></a>
                                                <a href="{{ route('edit-mu-ktp', $muItem->mus_id) }}" class="btn btn-warning btn-sm mb-1" title="Ubah Data"><i class="bi bi-pencil-square"></i></a>
                                                <a href="{{ route('delete-mu-ktp', $muItem->mus_id) }}" class="btn btn-danger btn-sm mb-1" title="Hapus Data" id="delete"><i class="fas fa-trash-alt"></i></a>
