    ...
    <div class="col-md-12">
        <div class="card shadow mb-4 border-left-primary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('store-ppak-ktp') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-5">
                                ...
                                <select id="merek" name="merek" class="form-control form-select">
                                    <option selected>Pilih Type/Merek</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a href="{{ route('index-ppak-ktp') }}" class="btn btn-secondary btn-block"><i class="fa fa-backward mr-2"></i> Kembali</a>
                            </div>
                        </div>
                </form>
            </div>
